        ...
        <header className="sticky top-0 z-30 bg-background/80 backdrop-blur-sm">
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center gap-3">
              {!state.user && (
                <button 
                  className="bg-secondary hover:bg-muted text-secondary-foreground px-4 py-2 rounded-lg font-medium transition-all text-sm flex items-center gap-2 border border-border hover:border-foreground/20"
